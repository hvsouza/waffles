...
def WaveformSet_from_hdf5_files(filepath_list : List[str] = [], 
                                ...
                                max_waffles_waveforms: Optional[int] = 1e6,
                                ) -> WaveformSet:
    """
    ...
    max_waffles_waveforms : int
        Maximum number of waveforms object to be decoded
    """
    ...
    for filepath in filepath_list:
        try:
            aux = WaveformSet_from_hdf5_file(filepath, read_full_streaming_data, allowed_endpoints)
        ...
        if len(output.waveforms) > max_waffles_waveforms:
            break
